...
namespace Cine.Migrations
{
    ...
    [Migration("20231023153119_NewTablesCountries")]
    partial class NewTablesCountries
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cine.DAL.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cine.DAL.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cine.DAL.Entities.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cine.DAL.Entities.City", b =>
                {
                    b.HasOne("Cine.DAL.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Cine.DAL.Entities.State", b =>
                {
                    b.HasOne("Cine.DAL.Entities.Country", "Country")
                        .WithMany("States")
